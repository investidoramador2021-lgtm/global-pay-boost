...
function getSmtpAccount(type: string): SmtpAccount {
  switch (type) {
    case 'system-error': {
      ...
      return { user, pass, displayName: 'MRC Global Pay Support' }
    }
    case 'risk-alert': {
      ...
      return { user, pass, displayName: 'MRC Global Pay Compliance' }
    }
    default: {
      ...
      return { user, pass, displayName: 'MRC Global Pay' }
    }
  }
}
...
const LANG_STRINGS: Record<string, {
  ...
  en: { greeting: 'Hello', receiptTitle: 'Exchange Receipt', pairLabel: 'Exchange Pair', depositLabel: 'Deposit Address', recipientLabel: 'Recipient Address', trackBtn: 'Track Your Exchange', footer: 'MRC Global Pay is a Registered Canadian MSB. Non-custodial service — we never hold your keys.', errorSubject: 'System Alert: Settlement Delay', verifySubject: 'Action Required: Verify Your MRC Global Pay Account', verifyTitle: 'Confirm Your Email', verifyBody: 'For your security, you must confirm your email within 48 hours. If not verified by {deadline}, this account and all associated data will be permanently deleted for your protection.', verifyBtn: 'Confirm My Email', loanConfirmSubject: 'Loan Confirmation — MRC Global Pay', loanConfirmTitle: 'Your Loan Has Been Created', loanConfirmBody: 'Your collateral has been received and your loan is now active. Please send the exact collateral amount to the address provided.', earnConfirmSubject: 'Earn Deposit Confirmation — MRC Global Pay', earnConfirmTitle: 'Your Earn Position Has Been Created', earnConfirmBody: 'Your deposit request is active. Send the exact amount to the address below to start accruing daily interest.', riskAlertSubject: 'LTV Risk Alert — MRC Global Pay', riskAlertTitle: 'Collateral Risk Alert', riskAlertYellow: 'Your loan LTV has entered the Yellow (Risk) zone. Please top up your collateral to avoid liquidation.', riskAlertRed: 'Your loan LTV has entered the Red (Liquidation) zone. Immediate action is required to prevent automatic liquidation.', collateralLabel: 'Collateral', ltvLabel: 'LTV Ratio', amountLabel: 'Loan Amount', assetLabel: 'Asset', apyLabel: 'APY', viewDashboard: 'View Dashboard', liabilityNote: 'Monitoring, security alerts, and liquidation execution are managed exclusively by our technology partner\'s automated risk engine.' },
  es: { greeting: 'Hola', receiptTitle: 'Recibo de Intercambio', pairLabel: 'Par de Intercambio', depositLabel: 'Dirección de Depósito', recipientLabel: 'Dirección del Destinatario', trackBtn: 'Seguir tu Intercambio', footer: 'MRC Global Pay es una MSB registrada en Canadá. Servicio no custodial — nunca mantenemos tus claves.', errorSubject: 'Alerta del Sistema: Retraso de Liquidación', verifySubject: 'Acción Requerida: Verifique su cuenta MRC Global Pay', verifyTitle: 'Confirme su Correo', verifyBody: 'Por su seguridad, debe confirmar su correo electrónico en 48 horas. Si no se verifica antes de {deadline}, esta cuenta será eliminada permanentemente.', verifyBtn: 'Confirmar mi Correo', loanConfirmSubject: 'Confirmación de Préstamo — MRC Global Pay', loanConfirmTitle: 'Su Préstamo Ha Sido Creado', loanConfirmBody: 'Su colateral ha sido recibido y su préstamo está activo. Envíe la cantidad exacta de colateral a la dirección proporcionada.', earnConfirmSubject: 'Confirmación de Depósito Earn — MRC Global Pay', earnConfirmTitle: 'Su Posición Earn Ha Sido Creada', earnConfirmBody: 'Su solicitud de depósito está activa. Envíe la cantidad exacta a la dirección a continuación para comenzar a acumular intereses diarios.', riskAlertSubject: 'Alerta de Riesgo LTV — MRC Global Pay', riskAlertTitle: 'Alerta de Riesgo de Colateral', riskAlertYellow: 'El LTV de su préstamo ha entrado en la zona Amarilla (Riesgo). Por favor, aumente su colateral para evitar la liquidación.', riskAlertRed: 'El LTV de su préstamo ha entrado en la zona Roja (Liquidación). Se requiere acción inmediata para evitar la liquidación automática.', collateralLabel: 'Colateral', ltvLabel: 'Ratio LTV', amountLabel: 'Monto del Préstamo', assetLabel: 'Activo', apyLabel: 'APY', viewDashboard: 'Ver Panel', liabilityNote: 'El monitoreo, las alertas de seguridad y la ejecución de liquidaciones son gestionados exclusivamente por el motor de riesgo automatizado de nuestro socio tecnológico.' },
  pt: { greeting: 'Olá', receiptTitle: 'Recibo de Troca', pairLabel: 'Par de Troca', depositLabel: 'Endereço de Depósito', recipientLabel: 'Endereço do Destinatário', trackBtn: 'Rastrear sua Troca', footer: 'MRC Global Pay é um MSB registrado no Canadá. Serviço não custodial — nunca guardamos suas chaves.', errorSubject: 'Alerta do Sistema: Atraso de Liquidação', verifySubject: 'Ação Necessária: Verifique sua conta MRC Global Pay', verifyTitle: 'Confirme seu Email', verifyBody: 'Para sua segurança, confirme seu email em 48 horas. Se não verificado até {deadline}, esta conta será permanentemente excluída.', verifyBtn: 'Confirmar meu Email', loanConfirmSubject: 'Confirmação de Empréstimo — MRC Global Pay', loanConfirmTitle: 'Seu Empréstimo Foi Criado', loanConfirmBody: 'Seu colateral foi recebido e seu empréstimo está ativo. Envie o valor exato do colateral para o endereço fornecido.', earnConfirmSubject: 'Confirmação de Depósito Earn — MRC Global Pay', earnConfirmTitle: 'Sua Posição Earn Foi Criada', earnConfirmBody: 'Sua solicitação de depósito está ativa. Envie o valor exato para o endereço abaixo para começar a acumular juros diários.', riskAlertSubject: 'Alerta de Risco LTV — MRC Global Pay', riskAlertTitle: 'Alerta de Risco de Colateral', riskAlertYellow: 'O LTV do seu empréstimo entrou na zona Amarela (Risco). Por favor, aumente seu colateral para evitar a liquidação.', riskAlertRed: 'O LTV do seu empréstimo entrou na zona Vermelha (Liquidação). Ação imediata é necessária para evitar a liquidação automática.', collateralLabel: 'Colateral', ltvLabel: 'Razão LTV', amountLabel: 'Valor do Empréstimo', assetLabel: 'Ativo', apyLabel: 'APY', viewDashboard: 'Ver Painel', liabilityNote: 'O monitoramento, alertas de segurança e execução de liquidações são gerenciados exclusivamente pelo motor de risco automatizado do nosso parceiro tecnológico.' },
  fr: { greeting: 'Bonjour', receiptTitle: 'Reçu d\'Échange', pairLabel: 'Paire d\'Échange', depositLabel: 'Adresse de Dépôt', recipientLabel: 'Adresse du Destinataire', trackBtn: 'Suivre votre Échange', footer: 'MRC Global Pay est un MSB enregistré au Canada. Service non-dépositaire — nous ne détenons jamais vos clés.', errorSubject: 'Alerte Système: Délai de Règlement', verifySubject: 'Action Requise: Vérifiez votre compte MRC Global Pay', verifyTitle: 'Confirmez votre Email', verifyBody: 'Pour votre sécurité, confirmez votre email sous 48 heures. S\'il n\'est pas vérifié avant {deadline}, ce compte sera définitivement supprimé.', verifyBtn: 'Confirmer mon Email', loanConfirmSubject: 'Confirmation de Prêt — MRC Global Pay', loanConfirmTitle: 'Votre Prêt a Été Créé', loanConfirmBody: 'Votre collatéral a été reçu et votre prêt est maintenant actif. Veuillez envoyer le montant exact du collatéral à l\'adresse fournie.', earnConfirmSubject: 'Confirmation de Dépôt Earn — MRC Global Pay', earnConfirmTitle: 'Votre Position Earn a Été Créée', earnConfirmBody: 'Votre demande de dépôt est active. Envoyez le montant exact à l\'adresse ci-dessous pour commencer à accumuler des intérêts quotidiens.', riskAlertSubject: 'Alerte de Risque LTV — MRC Global Pay', riskAlertTitle: 'Alerte de Risque de Collatéral', riskAlertYellow: 'Le LTV de votre prêt est entré dans la zone Jaune (Risque). Veuillez augmenter votre collatéral pour éviter la liquidation.', riskAlertRed: 'Le LTV de votre prêt est entré dans la zone Rouge (Liquidation). Une action immédiate est nécessaire pour éviter la liquidation automatique.', collateralLabel: 'Collatéral', ltvLabel: 'Ratio LTV', amountLabel: 'Montant du Prêt', assetLabel: 'Actif', apyLabel: 'APY', viewDashboard: 'Voir le Tableau de Bord', liabilityNote: 'La surveillance, les alertes de sécurité et l\'exécution des liquidations sont gérées exclusivement par le moteur de risque automatisé de notre partenaire technologique.' },
  ja: { greeting: 'こんにちは', receiptTitle: '交換レシート', pairLabel: '交換ペア', depositLabel: '入金アドレス', recipientLabel: '受取アドレス', trackBtn: '交換を追跡', footer: 'MRC Global Payはカナダ登録MSBです。ノンカストディアルサービス — お客様の鍵を保持しません。', errorSubject: 'システムアラート: 決済遅延', verifySubject: '対応が必要：MRC Global Payアカウントを確認してください', verifyTitle: 'メールアドレスを確認', verifyBody: 'セキュリティのため、48時間以内にメールを確認してください。{deadline}までに確認されない場合、アカウントは永久に削除されます。', verifyBtn: 'メールを確認', loanConfirmSubject: 'ローン確認 — MRC Global Pay', loanConfirmTitle: 'ローンが作成されました', loanConfirmBody: '担保が受領され、ローンが有効になりました。提供されたアドレスに正確な担保額を送信してください。', earnConfirmSubject: 'Earn入金確認 — MRC Global Pay', earnConfirmTitle: 'Earnポジションが作成されました', earnConfirmBody: '入金リクエストが有効です。毎日の利息の蓄積を開始するには、以下のアドレスに正確な金額を送信してください。', riskAlertSubject: 'LTVリスクアラート — MRC Global Pay', riskAlertTitle: '担保リスクアラート', riskAlertYellow: 'ローンのLTVがイエロー（リスク）ゾーンに入りました。清算を避けるため、担保を追加してください。', riskAlertRed: 'ローンのLTVがレッド（清算）ゾーンに入りました。自動清算を防ぐために即座の対応が必要です。', collateralLabel: '担保', ltvLabel: 'LTV比率', amountLabel: 'ローン額', assetLabel: '資産', apyLabel: 'APY', viewDashboard: 'ダッシュボードを見る', liabilityNote: '監視、セキュリティアラート、清算の実行は、当社のテクノロジーパートナーの自動リスクエンジンによって独占的に管理されています。' },
  tr: { greeting: 'Merhaba', receiptTitle: 'Değişim Makbuzu', pairLabel: 'Değişim Çifti', depositLabel: 'Depozit Adresi', recipientLabel: 'Alıcı Adresi', trackBtn: 'Değişiminizi Takip Edin', footer: 'MRC Global Pay, Kanada kayıtlı bir MSB\'dir. Emanetçi olmayan hizmet — anahtarlarınızı asla tutmuyoruz.', errorSubject: 'Sistem Uyarısı: Uzlaşma Gecikmesi', verifySubject: 'İşlem Gerekli: MRC Global Pay Hesabınızı Doğrulayın', verifyTitle: 'E-postanızı Onaylayın', verifyBody: 'Güvenliğiniz için e-postanızı 48 saat içinde onaylamanız gerekir. {deadline} tarihine kadar doğrulanmazsa bu hesap kalıcı olarak silinecektir.', verifyBtn: 'E-postamı Onayla', loanConfirmSubject: 'Kredi Onayı — MRC Global Pay', loanConfirmTitle: 'Krediniz Oluşturuldu', loanConfirmBody: 'Teminatınız alındı ve krediniz aktif. Lütfen sağlanan adrese tam teminat miktarını gönderin.', earnConfirmSubject: 'Earn Yatırım Onayı — MRC Global Pay', earnConfirmTitle: 'Earn Pozisyonunuz Oluşturuldu', earnConfirmBody: 'Yatırım talebiniz aktif. Günlük faiz biriktirmeye başlamak için aşağıdaki adrese tam miktarı gönderin.', riskAlertSubject: 'LTV Risk Uyarısı — MRC Global Pay', riskAlertTitle: 'Teminat Risk Uyarısı', riskAlertYellow: 'Kredinizin LTV\'si Sarı (Risk) bölgesine girdi. Tasfiyeden kaçınmak için teminatınızı artırın.', riskAlertRed: 'Kredinizin LTV\'si Kırmızı (Tasfiye) bölgesine girdi. Otomatik tasfiyeyi önlemek için acil müdahale gerekli.', collateralLabel: 'Teminat', ltvLabel: 'LTV Oranı', amountLabel: 'Kredi Miktarı', assetLabel: 'Varlık', apyLabel: 'APY', viewDashboard: 'Paneli Görüntüle', liabilityNote: 'İzleme, güvenlik uyarıları ve tasfiye işlemleri, teknoloji ortağımızın otomatik risk motoru tarafından münhasıran yönetilmektedir.' },
  hi: { greeting: 'नमस्ते', receiptTitle: 'एक्सचेंज रसीद', pairLabel: 'एक्सचेंज जोड़ी', depositLabel: 'जमा पता', recipientLabel: 'प्राप्तकर्ता पता', trackBtn: 'अपना एक्सचेंज ट्रैक करें', footer: 'MRC Global Pay एक कनाडा पंजीकृत MSB है। नॉन-कस्टोडियल सेवा — हम कभी आपकी कुंजी नहीं रखते।', errorSubject: 'सिस्टम चेतावनी: निपटान विलंब', verifySubject: 'कार्रवाई आवश्यक: अपना MRC Global Pay खाता सत्यापित करें', verifyTitle: 'अपना ईमेल पुष्टि करें', verifyBody: 'आपकी सुरक्षा के लिए, 48 घंटों के भीतर अपना ईमेल पुष्टि करें। {deadline} तक सत्यापित नहीं होने पर यह खाता स्थायी रूप से हटा दिया जाएगा।', verifyBtn: 'ईमेल पुष्टि करें', loanConfirmSubject: 'ऋण पुष्टिकरण — MRC Global Pay', loanConfirmTitle: 'आपका ऋण बनाया गया है', loanConfirmBody: 'आपका कोलैटरल प्राप्त हो गया है और आपका ऋण सक्रिय है। कृपया दिए गए पते पर सटीक कोलैटरल राशि भेजें।', earnConfirmSubject: 'Earn जमा पुष्टिकरण — MRC Global Pay', earnConfirmTitle: 'आपकी Earn पोज़ीशन बनाई गई है', earnConfirmBody: 'आपका जमा अनुरोध सक्रिय है। दैनिक ब्याज अर्जित करना शुरू करने के लिए नीचे दिए गए पते पर सटीक राशि भेजें।', riskAlertSubject: 'LTV जोखिम चेतावनी — MRC Global Pay', riskAlertTitle: 'कोलैटरल जोखिम चेतावनी', riskAlertYellow: 'आपके ऋण का LTV पीले (जोखिम) क्षेत्र में प्रवेश कर गया है। परिसमापन से बचने के लिए कृपया अपना कोलैटरल बढ़ाएं।', riskAlertRed: 'आपके ऋण का LTV लाल (परिसमापन) क्षेत्र में प्रवेश कर गया है। स्वचालित परिसमापन को रोकने के लिए तत्काल कार्रवाई आवश्यक है।', collateralLabel: 'कोलैटरल', ltvLabel: 'LTV अनुपात', amountLabel: 'ऋण राशि', assetLabel: 'संपत्ति', apyLabel: 'APY', viewDashboard: 'डैशबोर्ड देखें', liabilityNote: 'निगरानी, सुरक्षा चेतावनी और परिसमापन निष्पादन विशेष रूप से हमारे प्रौद्योगिकी भागीदार के स्वचालित जोखिम इंजन द्वारा प्रबंधित किए जाते हैं।' },
  vi: { greeting: 'Xin chào', receiptTitle: 'Biên Lai Giao Dịch', pairLabel: 'Cặp Giao Dịch', depositLabel: 'Địa Chỉ Nạp', recipientLabel: 'Địa Chỉ Nhận', trackBtn: 'Theo Dõi Giao Dịch', footer: 'MRC Global Pay là MSB đã đăng ký tại Canada. Dịch vụ phi lưu ký — chúng tôi không bao giờ giữ chìa khóa của bạn.', errorSubject: 'Cảnh Báo Hệ Thống: Trì Hoãn Thanh Toán', verifySubject: 'Hành Động Cần Thiết: Xác Minh Tài Khoản MRC Global Pay', verifyTitle: 'Xác Nhận Email', verifyBody: 'Vì bảo mật, bạn phải xác nhận email trong 48 giờ. Nếu không xác minh trước {deadline}, tài khoản sẽ bị xóa vĩnh viễn.', verifyBtn: 'Xác Nhận Email', loanConfirmSubject: 'Xác Nhận Khoản Vay — MRC Global Pay', loanConfirmTitle: 'Khoản Vay Của Bạn Đã Được Tạo', loanConfirmBody: 'Tài sản thế chấp đã được nhận và khoản vay đang hoạt động. Vui lòng gửi chính xác số tiền thế chấp đến địa chỉ được cung cấp.', earnConfirmSubject: 'Xác Nhận Nạp Earn — MRC Global Pay', earnConfirmTitle: 'Vị Thế Earn Đã Được Tạo', earnConfirmBody: 'Yêu cầu nạp tiền đang hoạt động. Gửi số tiền chính xác đến địa chỉ bên dưới để bắt đầu tích lũy lãi suất hàng ngày.', riskAlertSubject: 'Cảnh Báo Rủi Ro LTV — MRC Global Pay', riskAlertTitle: 'Cảnh Báo Rủi Ro Tài Sản Thế Chấp', riskAlertYellow: 'LTV khoản vay đã vào vùng Vàng (Rủi ro). Vui lòng tăng tài sản thế chấp để tránh thanh lý.', riskAlertRed: 'LTV khoản vay đã vào vùng Đỏ (Thanh lý). Cần hành động ngay lập tức để ngăn chặn thanh lý tự động.', collateralLabel: 'Thế Chấp', ltvLabel: 'Tỷ Lệ LTV', amountLabel: 'Số Tiền Vay', assetLabel: 'Tài Sản', apyLabel: 'APY', viewDashboard: 'Xem Bảng Điều Khiển', liabilityNote: 'Giám sát, cảnh báo bảo mật và thực hiện thanh lý được quản lý độc quyền bởi công cụ rủi ro tự động của đối tác công nghệ của chúng tôi.' },
  af: { greeting: 'Hallo', receiptTitle: 'Ruil Kwitansie', pairLabel: 'Ruil Paar', depositLabel: 'Deposito Adres', recipientLabel: 'Ontvanger Adres', trackBtn: 'Volg Jou Ruil', footer: 'MRC Global Pay is \'n Kanada-geregistreerde MSB. Nie-bewarende diens — ons hou nooit jou sleutels nie.', errorSubject: 'Stelsel Waarskuwing: Vestigingsvertraging', verifySubject: 'Aksie Vereis: Bevestig jou MRC Global Pay Rekening', verifyTitle: 'Bevestig Jou E-pos', verifyBody: 'Vir jou sekuriteit, bevestig jou e-pos binne 48 uur. As dit nie teen {deadline} geverifieer word nie, sal hierdie rekening permanent uitgevee word.', verifyBtn: 'Bevestig E-pos', loanConfirmSubject: 'Lening Bevestiging — MRC Global Pay', loanConfirmTitle: 'Jou Lening Is Geskep', loanConfirmBody: 'Jou onderpand is ontvang en jou lening is aktief. Stuur asseblief die presiese onderpandbedrag na die verskafde adres.', earnConfirmSubject: 'Earn Deposito Bevestiging — MRC Global Pay', earnConfirmTitle: 'Jou Earn Posisie Is Geskep', earnConfirmBody: 'Jou depositoversoek is aktief. Stuur die presiese bedrag na die adres hieronder om daagliks rente te begin verdien.', riskAlertSubject: 'LTV Risiko Waarskuwing — MRC Global Pay', riskAlertTitle: 'Onderpand Risiko Waarskuwing', riskAlertYellow: 'Jou lening se LTV het die Geel (Risiko) sone betree. Verhoog asseblief jou onderpand om likwidasie te vermy.', riskAlertRed: 'Jou lening se LTV het die Rooi (Likwidasie) sone betree. Onmiddellike aksie is nodig om outomatiese likwidasie te voorkom.', collateralLabel: 'Onderpand', ltvLabel: 'LTV Verhouding', amountLabel: 'Leningbedrag', assetLabel: 'Bate', apyLabel: 'APY', viewDashboard: 'Bekyk Dashboard', liabilityNote: 'Monitering, sekuriteitswaarskuwings en likwidasie-uitvoering word uitsluitlik bestuur deur ons tegnologiavennoot se outomatiese risiko-enjin.' },
  fa: { greeting: 'سلام', receiptTitle: 'رسید مبادله', pairLabel: 'جفت مبادله', depositLabel: 'آدرس واریز', recipientLabel: 'آدرس گیرنده', trackBtn: 'پیگیری مبادله', footer: 'MRC Global Pay یک MSB ثبت شده کانادا است. خدمات غیرامانی — ما هرگز کلیدهای شما را نگه نمی‌داریم.', errorSubject: 'هشدار سیستم: تأخیر تسویه', verifySubject: 'اقدام لازم: حساب MRC Global Pay خود را تأیید کنید', verifyTitle: 'ایمیل خود را تأیید کنید', verifyBody: 'برای امنیت شما، ایمیل خود را ظرف ۴۸ ساعت تأیید کنید. اگر تا {deadline} تأیید نشود، این حساب برای همیشه حذف خواهد شد.', verifyBtn: 'تأیید ایمیل', loanConfirmSubject: 'تأیید وام — MRC Global Pay', loanConfirmTitle: 'وام شما ایجاد شد', loanConfirmBody: 'وثیقه شما دریافت شد و وام شما فعال است. لطفاً مقدار دقیق وثیقه را به آدرس ارائه شده ارسال کنید.', earnConfirmSubject: 'تأیید سپرده Earn — MRC Global Pay', earnConfirmTitle: 'موقعیت Earn شما ایجاد شد', earnConfirmBody: 'درخواست سپرده شما فعال است. مبلغ دقیق را به آدرس زیر ارسال کنید تا سود روزانه خود را شروع کنید.', riskAlertSubject: 'هشدار ریسک LTV — MRC Global Pay', riskAlertTitle: 'هشدار ریسک وثیقه', riskAlertYellow: 'LTV وام شما وارد منطقه زرد (ریسک) شده است. لطفاً وثیقه خود را افزایش دهید تا از تسویه جلوگیری شود.', riskAlertRed: 'LTV وام شما وارد منطقه قرمز (تسویه) شده است. اقدام فوری برای جلوگیری از تسویه خودکار لازم است.', collateralLabel: 'وثیقه', ltvLabel: 'نسبت LTV', amountLabel: 'مبلغ وام', assetLabel: 'دارایی', apyLabel: 'APY', viewDashboard: 'مشاهده داشبورد', liabilityNote: 'نظارت، هشدارهای امنیتی و اجرای تسویه به طور انحصاری توسط موتور ریسک خودکار شریک فناوری ما مدیریت می‌شود.' },
  ur: { greeting: 'السلام علیکم', receiptTitle: 'تبادلہ رسید', pairLabel: 'تبادلہ جوڑا', depositLabel: 'جمع ایڈریس', recipientLabel: 'وصول کنندہ ایڈریس', trackBtn: 'اپنا تبادلہ ٹریک کریں', footer: 'MRC Global Pay کینیڈا میں رجسٹرڈ MSB ہے۔ نان-کسٹوڈیل سروس — ہم کبھی آپ کی چابیاں نہیں رکھتے۔', errorSubject: 'سسٹم الرٹ: تصفیہ تاخیر', verifySubject: 'عمل درکار: اپنا MRC Global Pay اکاؤنٹ تصدیق کریں', verifyTitle: 'ای میل کی تصدیق کریں', verifyBody: 'آپ کی سیکورٹی کے لیے، 48 گھنٹے میں ای میل کی تصدیق کریں۔ اگر {deadline} تک تصدیق نہیں ہوئی تو یہ اکاؤنٹ مستقل طور پر حذف ہو جائے گا۔', verifyBtn: 'ای میل تصدیق', loanConfirmSubject: 'قرض کی تصدیق — MRC Global Pay', loanConfirmTitle: 'آپ کا قرض بنایا گیا', loanConfirmBody: 'آپ کی ضمانت موصول ہو گئی ہے اور آپ کا قرض فعال ہے۔ براہ کرم فراہم کردہ ایڈریس پر عین ضمانت کی رقم بھیجیں۔', earnConfirmSubject: 'Earn جمع تصدیق — MRC Global Pay', earnConfirmTitle: 'آپ کی Earn پوزیشن بنائی گئی', earnConfirmBody: 'آپ کی جمع درخواست فعال ہے۔ روزانہ منافع حاصل کرنا شروع کرنے کے لیے نیچے دیے گئے ایڈریس پر عین رقم بھیجیں۔', riskAlertSubject: 'LTV خطرے کی وارننگ — MRC Global Pay', riskAlertTitle: 'ضمانت خطرے کی وارننگ', riskAlertYellow: 'آپ کے قرض کا LTV پیلے (خطرہ) زون میں داخل ہو گیا ہے۔ لیکویڈیشن سے بچنے کے لیے اپنی ضمانت بڑھائیں۔', riskAlertRed: 'آپ کے قرض کا LTV سرخ (لیکویڈیشن) زون میں داخل ہو گیا ہے۔ خودکار لیکویڈیشن روکنے کے لیے فوری کارروائی ضروری ہے۔', collateralLabel: 'ضمانت', ltvLabel: 'LTV تناسب', amountLabel: 'قرض کی رقم', assetLabel: 'اثاثہ', apyLabel: 'APY', viewDashboard: 'ڈیش بورڈ دیکھیں', liabilityNote: 'نگرانی، سیکورٹی الرٹس اور لیکویڈیشن کا نفاذ خصوصی طور پر ہمارے ٹیکنالوجی پارٹنر کے خودکار رسک انجن کے ذریعے منظم ہوتا ہے۔' },
  he: { greeting: 'שלום', receiptTitle: 'קבלת המרה', pairLabel: 'זוג המרה', depositLabel: 'כתובת הפקדה', recipientLabel: 'כתובת מקבל', trackBtn: 'עקוב אחרי ההמרה שלך', footer: 'MRC Global Pay הוא MSB רשום בקנדה. שירות ללא משמורת — אנחנו אף פעם לא מחזיקים במפתחות שלך.', errorSubject: 'התראת מערכת: עיכוב סליקה', verifySubject: 'נדרשת פעולה: אמת את חשבון MRC Global Pay שלך', verifyTitle: 'אשר את האימייל שלך', verifyBody: 'לביטחונך, אשר את האימייל שלך תוך 48 שעות. אם לא יאומת עד {deadline}, החשבון יימחק לצמיתות.', verifyBtn: 'אשר אימייל', loanConfirmSubject: 'אישור הלוואה — MRC Global Pay', loanConfirmTitle: 'ההלוואה שלך נוצרה', loanConfirmBody: 'הבטוחה שלך התקבלה וההלוואה פעילה. אנא שלח את סכום הבטוחה המדויק לכתובת שסופקה.', earnConfirmSubject: 'אישור הפקדת Earn — MRC Global Pay', earnConfirmTitle: 'פוזיציית ה-Earn שלך נוצרה', earnConfirmBody: 'בקשת ההפקדה שלך פעילה. שלח את הסכום המדויק לכתובת למטה כדי להתחיל לצבור ריבית יומית.', riskAlertSubject: 'התראת סיכון LTV — MRC Global Pay', riskAlertTitle: 'התראת סיכון בטוחה', riskAlertYellow: 'ה-LTV של ההלוואה שלך נכנס לאזור הצהוב (סיכון). אנא הגדל את הבטוחה כדי למנוע חיסול.', riskAlertRed: 'ה-LTV של ההלוואה שלך נכנס לאזור האדום (חיסול). נדרשת פעולה מיידית למניעת חיסול אוטומטי.', collateralLabel: 'בטוחה', ltvLabel: 'יחס LTV', amountLabel: 'סכום הלוואה', assetLabel: 'נכס', apyLabel: 'APY', viewDashboard: 'צפה בלוח בקרה', liabilityNote: 'ניטור, התראות אבטחה וביצוע חיסולים מנוהלים באופן בלעדי על ידי מנוע הסיכונים האוטומטי של שותף הטכנולוגיה שלנו.' },
  uk: { greeting: 'Привіт', receiptTitle: 'Квитанція Обміну', pairLabel: 'Пара Обміну', depositLabel: 'Адреса Депозиту', recipientLabel: 'Адреса Отримувача', trackBtn: 'Відстежити Ваш Обмін', footer: 'MRC Global Pay — зареєстрований канадський MSB. Некастодіальний сервіс — ми ніколи не зберігаємо ваші ключі.', errorSubject: 'Системне сповіщення: затримка розрахунків', verifySubject: 'Потрібна дія: Підтвердіть ваш обліковий запис MRC Global Pay', verifyTitle: 'Підтвердіть вашу електронну пошту', verifyBody: 'Для вашої безпеки підтвердіть email протягом 48 годин. Якщо не підтверджено до {deadline}, обліковий запис буде остаточно видалено.', verifyBtn: 'Підтвердити email', loanConfirmSubject: 'Підтвердження Позики — MRC Global Pay', loanConfirmTitle: 'Вашу Позику Створено', loanConfirmBody: 'Вашу заставу отримано та позика активна. Будь ласка, надішліть точну суму застави на надану адресу.', earnConfirmSubject: 'Підтвердження Депозиту Earn — MRC Global Pay', earnConfirmTitle: 'Вашу Earn Позицію Створено', earnConfirmBody: 'Ваш запит на депозит активний. Надішліть точну суму на адресу нижче, щоб почати накопичувати щоденні відсотки.', riskAlertSubject: 'Попередження про Ризик LTV — MRC Global Pay', riskAlertTitle: 'Попередження про Ризик Застави', riskAlertYellow: 'LTV вашої позики увійшов у Жовту (Ризик) зону. Будь ласка, збільшіть заставу, щоб уникнути ліквідації.', riskAlertRed: 'LTV вашої позики увійшов у Червону (Ліквідація) зону. Необхідні негайні дії для запобігання автоматичній ліквідації.', collateralLabel: 'Застава', ltvLabel: 'Коефіцієнт LTV', amountLabel: 'Сума Позики', assetLabel: 'Актив', apyLabel: 'APY', viewDashboard: 'Переглянути Панель', liabilityNote: 'Моніторинг, сповіщення безпеки та виконання ліквідацій управляються виключно автоматизованим движком ризиків нашого технологічного партнера.' },
}
...
<tr><td style="padding:32px 32px 24px;text-align:center;border-bottom:1px solid #334155;">
  <div style="font-size:24px;font-weight:700;color:#38bdf8;letter-spacing:-0.3px;">MRC Global Pay</div>
</td></tr>
...
<tr><td style="padding:20px 32px 32px;text-align:center;border-top:1px solid #334155;">
  ...
  <div style="font-size:10px;color:#475569;margin-top:8px;">© ${new Date().getFullYear()} MRC Global Pay. All rights reserved.</div>
</td></tr>
...
<tr><td style="padding:16px 32px 32px;text-align:center;border-top:1px solid #334155;">
  <div style="font-size:10px;color:#64748b;">Automated system monitoring — MRC Global Pay Infrastructure.</div>
</td></tr>
...
<table role="presentation" width="580" cellpadding="0" cellspacing="0" style="background:#1e293b;border-radius:16px;overflow:hidden;border:1px solid #334155;">
<tr><td style="padding:32px 32px 24px;text-align:center;border-bottom:1px solid #334155;">
  <div style="font-size:24px;font-weight:700;color:#D4AF37;letter-spacing:-0.3px;">MRC Global Pay</div>
</td></tr>
<tr><td style="padding:28px 32px 8px;text-align:center;">
...
<table role="presentation" width="580" cellpadding="0" cellspacing="0" style="background:#1e293b;border-radius:16px;overflow:hidden;border:1px solid #334155;">
<tr><td style="padding:32px 32px 24px;text-align:center;border-bottom:1px solid #334155;">
  <div style="font-size:24px;font-weight:700;color:#10b981;letter-spacing:-0.3px;">MRC Global Pay</div>
</td></tr>
<tr><td style="padding:28px 32px 8px;text-align:center;">
...
<tr><td style="padding:12px 32px 32px;text-align:center;border-top:1px solid #334155;">
  <div style="font-size:11px;color:#64748b;line-height:1.6;">${l.footer}</div>
  <div style="font-size:10px;color:#475569;margin-top:8px;">© ${new Date().getFullYear()} MRC Global Pay</div>
</td></tr>
</table></td></tr></table></body></html>`
}
  ...
  try {
    ...
    switch (type) {
      case 'receipt': {
        ...
        subject = `${l.receiptTitle} — MRC Global Pay`
        html = renderReceipt({
...
<table role="presentation" width="580" cellpadding="0" cellspacing="0" style="background:#1e293b;border-radius:16px;overflow:hidden;border:1px solid #334155;">
<tr><td style="padding:32px 32px 24px;text-align:center;border-bottom:1px solid #334155;">
  <div style="font-size:24px;font-weight:700;color:#38bdf8;">MRC Global Pay</div>
</td></tr>
<tr><td style="padding:28px 32px 8px;text-align:center;">
