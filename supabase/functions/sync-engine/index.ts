...
const TITLE_TEMPLATES: Record<string, string[]> = {
  en: [
    "Convert {from} to {to} Instantly | MRC Global Pay",
    "Swap {from} for {to} – No Account Required | MRC Global Pay",
    "{from} to {to} Exchange – Best Rates, Zero KYC",
    "Buy {to} with {from} in 60 Seconds | MRC Global Pay",
    "{from}→{to} Swap – 700+ Liquidity Sources",
    "Exchange {from} to {to} Anonymously | MSB-Registered",
    "Best {from} to {to} Rate Today | MRC Global Pay",
    "{from}/{to} Instant Swap – Canadian MSB Licensed",
    "Trade {from} for {to} – No Sign-Up Needed",
    "Quick {from} to {to} Conversion | MRC Global Pay",
    "Swap {from} ↔ {to} at Market Rate | MRC Global Pay",
    ...
    "Swap {from} to {to} Securely | MRC Global Pay",
    "{from}/{to} Live Rate & Instant Swap",
    "Best Way to Convert {from} to {to} in 2026",
  ],
  es: [
    "Convertir {from} a {to} al instante | MRC Global Pay",
    "Intercambiar {from} por {to} – Sin cuenta | MRC Global Pay",
    "Cambio de {from} a {to} – Mejores tasas, sin KYC",
    "Comprar {to} con {from} en 60 segundos | MRC Global Pay",
    "{from}→{to} Swap – 700+ fuentes de liquidez",
    "Intercambio de {from} a {to} anónimo | MSB registrado",
    "Mejor tasa de {from} a {to} hoy | MRC Global Pay",
    "Swap instantáneo {from}/{to} – Licencia MSB canadiense",
    "Cambiar {from} por {to} – Sin registro",
    "Conversión rápida de {from} a {to} | MRC Global Pay",
    "Swap {from} ↔ {to} a precio de mercado | MRC Global Pay",
    ...
    "Swap seguro de {from} a {to} | MRC Global Pay",
    "Tasa en vivo y swap instantáneo {from}/{to}",
    "Mejor forma de convertir {from} a {to} en 2026",
  ],
  pt: [
    "Converter {from} para {to} instantaneamente | MRC Global Pay",
    "Trocar {from} por {to} – Sem conta | MRC Global Pay",
    "Câmbio {from} para {to} – Melhores taxas, zero KYC",
    "Comprar {to} com {from} em 60 segundos | MRC Global Pay",
    "{from}→{to} Swap – 700+ fontes de liquidez",
    "Trocar {from} por {to} anonimamente | MSB registrado",
    "Melhor taxa {from} para {to} hoje | MRC Global Pay",
    "Swap instantâneo {from}/{to} – Licença MSB canadense",
    "Trocar {from} por {to} – Sem cadastro",
    "Conversão rápida {from} para {to} | MRC Global Pay",
    "Swap {from} ↔ {to} a taxa de mercado | MRC Global Pay",
    ...
    "Swap seguro de {from} para {to} | MRC Global Pay",
    "Taxa ao vivo e swap instantâneo {from}/{to}",
    "Melhor forma de converter {from} para {to} em 2026",
  ],
  fr: [
    "Convertir {from} en {to} instantanément | MRC Global Pay",
    "Échanger {from} contre {to} – Sans compte | MRC Global Pay",
    "Échange {from} vers {to} – Meilleurs taux, zéro KYC",
    "Acheter {to} avec {from} en 60 secondes | MRC Global Pay",
    "{from}→{to} Swap – 700+ sources de liquidité",
    "Échange anonyme {from} vers {to} | MSB enregistré",
    "Meilleur taux {from} vers {to} aujourd'hui | MRC Global Pay",
    "Swap instantané {from}/{to} – Licence MSB canadienne",
    "Échanger {from} contre {to} – Sans inscription",
    "Conversion rapide {from} vers {to} | MRC Global Pay",
    "Swap {from} ↔ {to} au taux du marché | MRC Global Pay",
    ...
    "Swap sécurisé {from} vers {to} | MRC Global Pay",
    "Taux en direct et swap instantané {from}/{to}",
    "Meilleure façon de convertir {from} en {to} en 2026",
  ],
  ja: [
    "{from}を{to}に即座に変換 | MRC Global Pay",
    "{from}を{to}に交換 – アカウント不要 | MRC Global Pay",
    "{from}→{to}交換 – 最高レート、KYC不要",
    "60秒で{from}から{to}を購入 | MRC Global Pay",
    "{from}→{to}スワップ – 700+流動性ソース",
    "{from}を{to}に匿名で交換 | MSB登録済み",
    "本日の{from}→{to}最高レート | MRC Global Pay",
    "{from}/{to}即時スワップ – カナダMSBライセンス",
    "{from}を{to}に交換 – 登録不要",
    "{from}から{to}への迅速な変換 | MRC Global Pay",
    "{from} ↔ {to}を市場レートでスワップ",
    ...
    "{from}を{to}に安全にスワップ | MRC Global Pay",
    "{from}/{to}ライブレート＆即時スワップ",
    "2026年に{from}を{to}に変換する最良の方法",
  ],
  fa: [
    "تبدیل {from} به {to} فوری | MRC Global Pay",
    "مبادله {from} با {to} – بدون حساب | MRC Global Pay",
    "تبادل {from} به {to} – بهترین نرخ، بدون KYC",
    "خرید {to} با {from} در ۶۰ ثانیه | MRC Global Pay",
    "سواپ {from}→{to} – بیش از ۷۰۰ منبع نقدینگی",
    "تبادل ناشناس {from} به {to} | ثبت MSB",
    "بهترین نرخ {from} به {to} امروز | MRC Global Pay",
    "سواپ فوری {from}/{to} – مجوز MSB کانادا",
    "مبادله {from} با {to} – بدون ثبت‌نام",
    "تبدیل سریع {from} به {to} | MRC Global Pay",
  ...
  he: [
    ...
    "סוואפ מאובטח {from} ל-{to} | MRC Global Pay",
    "שער חי וסוואפ מיידי {from}/{to}",
    "הדרך הטובה ביותר להמיר {from} ל-{to} ב-2026",
  ],
  af: [
    "Omskep {from} na {to} onmiddellik | MRC Global Pay",
    "Ruil {from} vir {to} – Geen rekening nodig | MRC Global Pay",
    "{from} na {to} omruiling – Beste koerse, geen KYC",
    "Koop {to} met {from} in 60 sekondes | MRC Global Pay",
    "{from}→{to} Ruil – 700+ likiditeitsbronne",
    "Ruil {from} na {to} anoniem | MSB-geregistreer",
    "Beste {from} na {to} koers vandag | MRC Global Pay",
    "Onmiddellike ruil {from}/{to} – Kanadese MSB-lisensie",
    "Ruil {from} vir {to} – Geen registrasie nodig",
    "Vinnige {from} na {to} omskakeling | MRC Global Pay",
    "Ruil {from} ↔ {to} teen markkoers | MRC Global Pay",
  ...
  hi: [
    ...
    "{from} से {to} सुरक्षित स्वैप | MRC Global Pay",
    "लाइव रेट और तत्काल स्वैप {from}/{to}",
    "2026 में {from} को {to} में बदलने का सबसे अच्छा तरीका",
  ],
  vi: [
    "Đổi {from} sang {to} tức thì | MRC Global Pay",
    "Hoán đổi {from} lấy {to} – Không cần tài khoản | MRC Global Pay",
    "Sàn {from} sang {to} – Tỷ giá tốt nhất, không KYC",
    "Mua {to} bằng {from} trong 60 giây | MRC Global Pay",
    "Swap {from}→{to} – 700+ nguồn thanh khoản",
    "Đổi {from} sang {to} ẩn danh | MSB đã đăng ký",
    "Tỷ giá {from} sang {to} tốt nhất hôm nay | MRC Global Pay",
    "Swap tức thì {from}/{to} – Giấy phép MSB Canada",
    "Đổi {from} lấy {to} – Không cần đăng ký",
    "Chuyển đổi nhanh {from} sang {to} | MRC Global Pay",
  ...
  uk: [
    ...
    "Безпечний свап {from} на {to} | MRC Global Pay",
...
const DESC_TEMPLATES: Record<string, string[]> = {
  en: [
    ...
    "Buy {to} with {from} through MRC Global Pay's non-custodial swap engine. Sub-60-second settlement, transparent 0.4% fee, no account required, Canadian MSB-registered.",
    ...
    "{from} → {to} in under a minute. MRC Global Pay aggregates 700+ liquidity sources to find the deepest pool, then routes the swap directly to your wallet. No KYC required.",
    ...
    "{from}/{to} swap on the MRC Global Pay aggregator. We scan 700+ liquidity venues and route to the best execution, settling on-chain in under 60 seconds. MSB C100000015.",
    ...
    "{from} to {to} swap on MRC Global Pay — the aggregator licensed under Canadian MSB regulations. 700+ liquidity sources, transparent 0.4% fee, instant on-chain settlement.",
  ...
  es: [
    ...
    "Compra {to} con {from} mediante el motor de swap no custodial de MRC Global Pay. Liquidación en menos de 60s, comisión 0.4%, sin cuenta, MSB canadiense registrado.",
    ...
    "{from} → {to} en menos de un minuto. MRC Global Pay agrega 700+ fuentes de liquidez para encontrar el pool más profundo y enruta el swap directo a tu wallet. Sin KYC.",
    ...
    "Swap {from}/{to} en el agregador MRC Global Pay. Escaneamos 700+ venues de liquidez y enrutamos a la mejor ejecución, liquidando on-chain en < 60s. MSB C100000015.",
    ...
    "Swap {from} a {to} en MRC Global Pay — el agregador licenciado bajo regulaciones MSB canadienses. 700+ fuentes de liquidez, comisión transparente 0.4%, liquidación instantánea.",
  ...
  pt: [
    ...
    "Compre {to} com {from} pelo motor de swap não custodial da MRC Global Pay. Liquidação em menos de 60s, taxa 0.4%, sem conta, MSB canadense registrado.",
    ...
    "{from} → {to} em menos de um minuto. MRC Global Pay agrega 700+ fontes de liquidez para encontrar o pool mais profundo e roteia o swap direto na sua wallet. Sem KYC.",
    ...
    "Swap {from}/{to} no agregador MRC Global Pay. Escaneamos 700+ venues de liquidez e roteamos para a melhor execução, liquidando on-chain em < 60s. MSB C100000015.",
    ...
    "Swap {from} para {to} na MRC Global Pay — o agregador licenciado sob regulações MSB canadenses. 700+ fontes de liquidez, taxa transparente 0.4%, liquidação instantânea on-chain.",
  ...
  fr: [
    ...
    "Achetez {to} avec {from} via le moteur de swap non-custodial MRC Global Pay. Règlement en moins de 60s, frais 0.4%, sans compte, MSB canadien enregistré.",
    ...
    "{from} → {to} en moins d'une minute. MRC Global Pay agrège 700+ sources de liquidité pour trouver le pool le plus profond et route le swap direct vers votre wallet. Sans KYC.",
    ...
    "Swap {from}/{to} sur l'agrégateur MRC Global Pay. Nous scannons 700+ venues de liquidité et routons à la meilleure exécution, réglant on-chain en < 60s. MSB C100000015.",
    ...
    "Swap {from} vers {to} sur MRC Global Pay — l'agrégateur licencié sous régulations MSB canadiennes. 700+ sources de liquidité, frais transparents 0.4%, règlement on-chain instantané.",
  ...
  ja: [
    ...
    "{from}でMRC Global Payの非カストディアル・スワップエンジンを通じて{to}を購入。60秒以内の決済、透明な0.4%手数料、アカウント不要、カナダMSB登録。",
    ...
    "{from} → {to}を1分以内で。MRC Global Payは700+流動性ソースを集約して最も深いプールを見つけ、スワップを直接ウォレットにルーティング。KYC不要。",
    ...
    "MRC Global Payアグリゲーターでの{from}/{to}スワップ。700+流動性ベニューをスキャンし、最良の執行にルーティング、60秒以内にオンチェーン決済。MSB C100000015。",
    ...
    "MRC Global Payでの{from}→{to}スワップ — カナダMSB規制下のライセンスアグリゲーター。700+流動性ソース、透明な0.4%手数料、即時オンチェーン決済。",
  ...
  fa: [
    ...
    "خرید {to} با {from} از طریق موتور سواپ غیرحضانتی MRC Global Pay. تسویه کمتر از ۶۰ ثانیه، کارمزد ۰.۴٪، بدون حساب، MSB کانادا ثبت‌شده.",
    ...
    "{from} ← {to} در کمتر از یک دقیقه. MRC Global Pay ۷۰۰+ منبع نقدینگی را تجمیع و عمیق‌ترین استخر را پیدا می‌کند، سپس سواپ را مستقیم به کیف پول شما هدایت. بدون KYC.",
    ...
    "سواپ {from}/{to} در تجمیع‌کننده MRC Global Pay. ما ۷۰۰+ مکان نقدینگی را اسکن و به بهترین اجرا مسیریابی، تسویه آن‌چین در < ۶۰ ثانیه. MSB C100000015.",
    ...
    "سواپ {from} به {to} در MRC Global Pay — تجمیع‌کننده مجاز تحت مقررات MSB کانادا. ۷۰۰+ منبع نقدینگی، کارمزد شفاف ۰.۴٪، تسویه آنی آن‌چین.",
  ...
  ur: [
    ...
    "MRC Global Pay کے غیر تحویلی سواپ انجن کے ذریعے {from} سے {to} خریدیں۔ 60 سیکنڈ سے کم میں تصفیہ، 0.4% فیس، اکاؤنٹ نہیں، کینیڈین MSB رجسٹرڈ۔",
    ...
    "{from} → {to} ایک منٹ سے کم میں۔ MRC Global Pay 700+ لیکویڈیٹی ذرائع جمع کرتا ہے گہرا ترین پول تلاش کرنے کے لیے، پھر سواپ کو براہ راست والیٹ پر روٹ کرتا ہے۔ KYC نہیں۔",
    ...
    "MRC Global Pay اگریگیٹر پر {from}/{to} سواپ۔ ہم 700+ لیکویڈیٹی وینیوز اسکین کرتے ہیں اور بہترین عمل درآمد پر روٹ، 60 سیکنڈ میں آن چین تصفیہ۔ MSB C100000015۔",
    ...
    "MRC Global Pay پر {from} سے {to} سواپ — کینیڈین MSB ریگولیشنز کے تحت لائسنس یافتہ اگریگیٹر۔ 700+ لیکویڈیٹی ذرائع، شفاف 0.4% فیس، فوری آن چین تصفیہ۔",
  ...
  he: [
    ...
    "קנו {to} עם {from} דרך מנוע הסוואפ הלא משמורני של MRC Global Pay. סליקה תוך פחות מ-60 שניות, עמלה שקופה 0.4%, ללא חשבון, רשום MSB קנדי.",
    ...
    "{from} → {to} תוך פחות מדקה. MRC Global Pay מצרפת 700+ מקורות נזילות למציאת בריכה עמוקה ומנתבת את הסוואפ ישירות לארנק שלך. ללא KYC.",
    ...
    "סוואפ {from}/{to} במצרף MRC Global Pay. אנו סורקים 700+ זירות נזילות ומנתבים לביצוע הטוב ביותר, סליקה on-chain תוך פחות מ-60 שניות. MSB C100000015.",
    ...
    "סוואפ {from} ל-{to} ב-MRC Global Pay — המצרף בעל הרישיון תחת תקנות MSB קנדיות. 700+ מקורות נזילות, עמלת ניתוב שקופה 0.4%, סליקה on-chain מיידית.",
  ...
  af: [
    ...
    "Koop {to} met {from} deur MRC Global Pay se nie-bewaringsruilenjin. Vereffening in minder as 60 sekondes, deursigtige 0.4% fooi, geen rekening nodig, Kanadese MSB-geregistreer.",
    ...
    "{from} → {to} in minder as 'n minuut. MRC Global Pay aggregeer 700+ likiditeitsbronne om die diepste poel te vind en roete die ruil direk na jou wallet. Geen KYC vereis.",
    ...
    "{from}/{to} ruil op die MRC Global Pay aggregator. Ons skandeer 700+ likiditeitsplekke en roete na die beste uitvoering, vereffen on-chain in minder as 60 sekondes. MSB C100000015.",
    ...
    "{from} na {to} ruil op MRC Global Pay — die aggregator gelisensieer onder Kanadese MSB-regulasies. 700+ likiditeitsbronne, deursigtige 0.4% fooi, oombliklike on-chain vereffening.",
  ...
  hi: [
    ...
    "MRC Global Pay के नॉन-कस्टोडियल स्वैप इंजन के माध्यम से {from} से {to} खरीदें। 60 सेकंड से कम सेटलमेंट, पारदर्शी 0.4% शुल्क, कोई खाता नहीं, कनाडाई MSB-पंजीकृत।",
    ...
    "{from} → {to} एक मिनट से कम में। MRC Global Pay सबसे गहरा पूल खोजने के लिए 700+ तरलता स्रोतों को एग्रीगेट करता है, फिर स्वैप को सीधे आपके वॉलेट में रूट करता है। KYC आवश्यक नहीं।",
    ...
    "MRC Global Pay एग्रीगेटर पर {from}/{to} स्वैप। हम 700+ तरलता वेन्यू स्कैन करते हैं और सर्वश्रेष्ठ निष्पादन के लिए रूट करते हैं, 60 सेकंड से कम में ऑन-चेन सेटल। MSB C100000015।",
    ...
    "MRC Global Pay पर {from} से {to} स्वैप — कनाडाई MSB नियमों के तहत लाइसेंस प्राप्त एग्रीगेटर। 700+ तरलता स्रोत, पारदर्शी 0.4% शुल्क, तत्काल ऑन-चेन सेटलमेंट।",
  ...
  vi: [
    ...
    "Mua {to} bằng {from} qua động cơ swap phi lưu ký của MRC Global Pay. Thanh toán dưới 60 giây, phí minh bạch 0.4%, không cần tài khoản, đăng ký MSB Canada.",
    ...
    "{from} → {to} dưới một phút. MRC Global Pay tổng hợp 700+ nguồn thanh khoản để tìm pool sâu nhất, sau đó định tuyến swap thẳng vào ví của bạn. Không cần KYC.",
    ...
    "Swap {from}/{to} trên bộ tổng hợp MRC Global Pay. Chúng tôi quét 700+ địa điểm thanh khoản và định tuyến đến thực thi tốt nhất, thanh toán on-chain dưới 60 giây. MSB C100000015.",
    ...
    "Swap {from} sang {to} trên MRC Global Pay — bộ tổng hợp được cấp phép theo quy định MSB Canada. 700+ nguồn thanh khoản, phí minh bạch 0.4%, thanh toán on-chain tức thì.",
  ...
  tr: [
    ...
    "MRC Global Pay'in emanetsiz swap motoru üzerinden {from} ile {to} satın alın. 60 saniyeden kısa ödeme, şeffaf %0.4 ücret, hesap yok, Kanada MSB-kayıtlı.",
    ...
    "{from} → {to} bir dakikadan az sürede. MRC Global Pay en derin havuzu bulmak için 700+ likidite kaynağını toplar, ardından swap'ı doğrudan cüzdanınıza yönlendirir. KYC gerekmez.",
    ...
    "MRC Global Pay toplayıcısında {from}/{to} swap. 700+ likidite mekanını tarar ve en iyi yürütmeye yönlendiririz, 60 saniyeden kısa zincir-üstü ödeme. MSB C100000015.",
    ...
    "MRC Global Pay'de {from} → {to} swap — Kanada MSB düzenlemeleri altında lisanslı toplayıcı. 700+ likidite kaynağı, şeffaf %0.4 ücret, anında zincir-üstü ödeme.",
  ...
  uk: [
    ...
    "Купіть {to} за {from} через некустодіальний swap-двигун MRC Global Pay. Розрахунок менше ніж за 60 секунд, прозора комісія 0.4%, без акаунту, зареєстровано MSB Канади.",
    ...
    "{from} → {to} менше ніж за хвилину. MRC Global Pay агрегує 700+ джерел ліквідності, щоб знайти найглибший пул, потім маршрутизує swap прямо на ваш гаманець. KYC не потрібно.",
    ...
    "{from}/{to} swap на агрегаторі MRC Global Pay. Ми скануємо 700+ майданчиків ліквідності та маршрутизуємо до найкращого виконання, розрахунок on-chain менше 60с. MSB C100000015.",
    ...
    "{from} на {to} swap на MRC Global Pay — агрегатор, ліцензований під канадськими MSB-регуляціями. 700+ джерел ліквідності, прозора комісія 0.4%, миттєвий on-chain розрахунок.",
