  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Swap ${from_token} to ${to_token} from $0.30 in under 60 seconds. ${network_advantage}. Registration-free, non-custodial. 6,000+ tokens supported.`} />
