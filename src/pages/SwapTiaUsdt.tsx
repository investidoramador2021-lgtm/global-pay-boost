  ...
  <SwapPairLanding
    ...
    extraFaqs={[
      ...
      },
      {
        ...
        a: "Yes. MRC Global Pay eliminates the standard confirmation wait. Our liquidity rails connect directly to protocol-level liquidity optimized for Celestia, enabling immediate TIA to USDT settlement — no exchange withdrawal queues.",
      },
      {
