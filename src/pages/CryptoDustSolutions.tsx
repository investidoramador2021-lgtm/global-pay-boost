...
/* ---------- FAQ ---------- */
const faqs = [
  { q: "How to sweep crypto dust safely?", a: "Select your dust token from 500+ supported assets, enter the micro-balance amount, choose a target stablecoin (USDT, USDC, etc.), and execute the swap through our non-custodial settlement engine. No registration required for qualifying amounts, with settlement in under 60 seconds via a FINTRAC-registered Money Services Business." },
