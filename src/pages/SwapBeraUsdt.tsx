...
const SwapBeraUsdt = () => (
  <SwapPairLanding
    ...
    whyText="Berachain (BERA) introduced Proof-of-Liquidity consensus to the blockchain space, creating a new paradigm for capital efficiency. MRC GlobalPay's 2026 liquidity architecture utilizes pre-funded vaults and direct-to-protocol routing — eliminating the 3–6 confirmation wait times common on standard exchanges, delivering USDC to your wallet in under 60 seconds."
    extraFaqs={[
      {
      ...
      },
      {
        ...
        a: "Yes. MRC GlobalPay's liquidity rails eliminate the standard multi-block confirmation wait. Our pre-funded USDC vaults execute BERA swaps with immediate settlement — no withdrawal queues, no network congestion delays.",
      },
      {
