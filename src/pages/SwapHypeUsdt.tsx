...
const SwapHypeUsdt = () => (
  <SwapPairLanding
    ...
    whyText="Hyperliquid (HYPE) is the March 2026 breakout token. Its native L1 chain delivers sub-second finality, and MRC Global Pay matches that speed with pre-funded USDT liquidity vaults. Our 2026 liquidity architecture utilizes pre-funded vaults and direct-to-protocol routing — eliminating the 3–6 confirmation wait times common on standard exchanges. During high-volatility events when other DEXs face congestion, our direct liquidity routing guarantees execution."
    extraFaqs={[
      {
        q: "Why is MRC Global Pay the fastest way to swap HYPE?",
      ...
      },
      {
        ...
        a: "Yes. Unlike decentralized venues that experience congestion during pumps, MRC Global Pay uses pre-funded liquidity vaults that execute regardless of on-chain congestion. Processing: under 60 seconds even during peak volatility.",
      },
      {
