...
const SwapBtcUsdc = () => (
  <SwapPairLanding
    ...
    subHeadline="Processing: under 60 seconds. Settlement: immediate on-chain finality. Zero confirmation delays. Skip Bitcoin's standard 6-confirmation wait with direct liquidity routing."
    whyText="BTC/USDC is the primary institutional and safety pair in March 2026. Whether you're de-risking a Bitcoin position or moving into regulated stablecoins, our direct liquidity routing skips Bitcoin's standard 6-confirmation wait. Processing under 60 seconds through pre-funded liquidity vaults — immediate settlement finality, no slippage on large orders."
    extraFaqs={[
      {
