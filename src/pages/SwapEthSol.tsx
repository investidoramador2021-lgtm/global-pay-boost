...
const SwapEthSol = () => (
  <SwapPairLanding
    ...
    extraFaqs={[
      ...
      {
        q: "How fast is an ETH to SOL swap on MRC GlobalPay?",
      ...
      },
      {
        ...
        a: "There is no maximum. The minimum is just $0.30 USD equivalent — far lower than the $15+ minimums required by competing exchanges. This makes MRC GlobalPay ideal for converting leftover ETH dust into SOL.",
      },
      {
        q: "Do I need to register or complete KYC to swap ETH to SOL?",
        a: "No. MRC GlobalPay is completely registration-free. Enter your SOL wallet address, send ETH, and receive SOL — no email, no identity verification, no account creation required.",
      },
    ]}
  />
);
