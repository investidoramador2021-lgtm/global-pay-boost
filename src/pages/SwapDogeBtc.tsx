...
const SwapDogeBtc = () => (
  <SwapPairLanding
    ...
    whyText="Dogecoin remains the deepest memecoin liquidity pool in 2026 — and the most common exit path for long-term holders is into Bitcoin. MRC Global Pay routes DOGE → BTC across multiple top-tier liquidity providers in parallel, locks the best quote, and delivers native BTC to any standard Bitcoin address. No wrapped tokens. No exchange account."
    extraFaqs={[
      {
