...
const SwapDogeUsdt = () => (
  <SwapPairLanding
    ...
    whyText="Dogecoin remains one of the highest-volume crypto pairs globally in 2026, with steady ETF speculation and continued payments-utility growth. MRC GlobalPay matches DOGE's native 1-minute block time with pre-funded USDT liquidity vaults — delivering the cleanest DOGE-to-stablecoin conversion available. Zero confirmation delays beyond the single Dogecoin block needed for chain finality."
    extraFaqs={[
      {
        q: "Can I swap DOGE without verifying my identity?",
        a: "Yes. MRC GlobalPay does not require KYC for typical retail swap volumes. Send DOGE from your wallet, receive USDT at the destination you specify.",
      },
      {
      ...
      {
        q: "How does MRC GlobalPay handle DOGE swap volatility?",
