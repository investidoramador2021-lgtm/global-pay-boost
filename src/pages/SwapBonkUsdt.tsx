...
const SwapBonkUsdt = () => (
  <SwapPairLanding
    ...
    whyText="BONK is the most enduring Solana memecoin and remains one of the highest-volume SPL tokens through 2026. MRC Global Pay leverages Solana's sub-second finality combined with pre-funded USDT liquidity vaults — delivering the fastest BONK-to-stablecoin conversion available on a non-custodial route. Zero confirmation delays."
    extraFaqs={[
      {
      ...
      },
      {
        ...
        a: "Wrapped BONK exists on Ethereum, BSC, and Base. Native SPL BONK on Solana is the canonical asset and has the deepest liquidity — that is what MRC Global Pay routes by default.",
      },
    ]}
  />
);
