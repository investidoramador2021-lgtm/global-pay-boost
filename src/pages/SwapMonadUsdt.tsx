...
const SwapMonadUsdt = () => (
  <SwapPairLanding
    ...
    subHeadline="Move capital across parallelized EVM rails with 2026 speed. Zero-delay, one-click settlement. MRC GlobalPay's liquidity rails are specifically optimized for MONAD's parallel-execution architecture."
    whyText="Monad brought parallel transaction execution to the EVM, achieving throughput levels previously impossible on Ethereum-compatible chains. MRC GlobalPay's 2026 liquidity architecture utilizes pre-funded vaults and direct-to-protocol routing — eliminating the 3–6 confirmation wait times common on standard exchanges, delivering ETH to your wallet in under 60 seconds."
    extraFaqs={[
      {
      ...
      },
      {
        ...
        a: "Yes. MRC GlobalPay's liquidity rails eliminate the standard multi-block confirmation wait. Our pre-funded ETH vaults execute MONAD swaps with immediate settlement — taking full advantage of Monad's sub-second finality.",
      },
      {
