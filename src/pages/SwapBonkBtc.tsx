...
const SwapBonkBtc = () => (
  <SwapPairLanding
    ...
    whyText="BONK holders looking to bank gains into Bitcoin usually move through Solana → USDC → CEX → BTC, losing 1–2% in cumulative spread and exposing themselves to custodial risk at the CEX hop. MRC Global Pay collapses that into a single BONK → BTC swap with one locked quote and native BTC settlement to your specified address."
    extraFaqs={[
      {
