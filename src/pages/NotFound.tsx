...
const NotFound = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Page Not Found — MRC Global Pay</title>
        <meta name="description" content="The page you requested could not be found. Return to MRC Global Pay to instantly swap 6,000+ cryptocurrencies from $0.30 — registration-free and non-custodial." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Page Not Found — MRC Global Pay" />
        <meta property="og:description" content="The page you are looking for does not exist. Return to MRC Global Pay to swap 6,000+ cryptocurrencies instantly from $0.30." />
        ...
        <meta name="twitter:title" content="Page Not Found — MRC Global Pay" />
        <meta name="twitter:description" content="The page you are looking for does not exist. Return to MRC Global Pay to swap 6,000+ cryptocurrencies instantly." />
      ...
      <div className="flex min-h-screen items-center justify-center bg-muted">
        <div className="text-center max-w-lg px-4">
          ...
          <p className="mb-6 text-lg text-muted-foreground">
            ...
            MRC Global Pay lets you instantly swap 6,000+ cryptocurrencies starting from just $0.30 — no account required.
          </p>
