  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="The page you are looking for does not exist. Return to MRC GlobalPay to swap 6,000+ cryptocurrencies instantly from $0.30." />
      ...
      <div className="flex min-h-screen items-center justify-center bg-muted">
        <div className="text-center max-w-lg px-4">
          ...
          <p className="mb-6 text-lg text-muted-foreground">
            ...
            MRC GlobalPay lets you instantly swap 6,000+ cryptocurrencies starting from just $0.30 — no account required.
          </p>
