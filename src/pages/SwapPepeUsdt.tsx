...
const SwapPepeUsdt = () => (
  <SwapPairLanding
    ...
    whyText="PEPE volatility creates execution windows that close in seconds. MRC GlobalPay aggregates PEPE/USDT liquidity across multiple top-tier providers, locks the quoted rate before funding, and routes directly into pre-funded USDT vaults — eliminating the 3–6 confirmation wait on standard Ethereum swaps. The number you see is the number you receive."
    extraFaqs={[
      {
        q: "What is the minimum PEPE swap on MRC GlobalPay?",
      ...
      },
      {
        ...
        a: "Memecoin-basket ETF filings expected to receive H2 2026 decisions, plus PEPE deployments to Base and Arbitrum lowering retail entry costs, are driving renewed PEPE interest. MRC GlobalPay processes PEPE/USDT swaps in under 60 seconds even during peak-volatility windows.",
      },
    ]}
  />
);
