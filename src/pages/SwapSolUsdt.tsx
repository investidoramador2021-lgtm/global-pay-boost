...
const SwapSolUsdt = () => (
  <SwapPairLanding
    ...
    subHeadline="Processing: under 60 seconds. Settlement: immediate on-chain finality. Zero confirmation delays. MRC Global Pay uses direct liquidity routing to bypass standard confirmation waits."
    ...
    extraFaqs={[
      {
        ...
        a: "Solana's ecosystem has reached critical mass with DePIN, gaming, and DeFi protocols driving billions in daily on-chain volume. Traders constantly rotate between SOL and USDT, making this the #1 retail pair by volume. Processing: under 60 seconds on MRC Global Pay.",
      },
    ]}
  />
);
