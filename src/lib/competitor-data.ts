...
export const COMPETITORS: Competitor[] = [
  ...
  { id: "28", slug: "stargate", name: "Stargate Finance", min_swap_usd: "10.00", kyc_policy: "No Account Required", avg_speed: "2 - 5 min", fees: "0.06%", primary_weakness: "Stablecoin focus only", mrc_advantage: "500+ volatile & stable assets" },
  ...
  { id: "32", slug: "shakepay", name: "Shakepay", min_swap_usd: "10.00", kyc_policy: "Mandatory ID Verification", avg_speed: "Instant", fees: "Spread-based", primary_weakness: "Only BTC/ETH supported", mrc_advantage: "500+ token support" },
