...
Abre la [interfaz de intercambio instantáneo de MRC Global Pay](/#exchange), configura BTC como origen y ETH como destino, luego ingresa tu tamaño. Comienza con tu tamaño *real* previsto — el comportamiento de la ruta puede cambiar materialmente entre niveles.
...
Abra a [interface de troca instantânea do MRC Global Pay](/#exchange), defina BTC como origem e ETH como destino, depois insira seu tamanho. Comece com seu tamanho *real* pretendido — o comportamento da rota pode mudar materialmente entre níveis.
...
Ouvrez l'[interface d'échange instantané MRC Global Pay](/#exchange), définissez BTC comme source et ETH comme destination.
...
[MRC Global Payのインスタントスワップインターフェース](/#exchange)を開き、BTCをソース、ETHをデスティネーションに設定。
...
פתחו את [ממשק ההמרה המיידית של MRC Global Pay](/#exchange), הגדירו BTC כמקור ו-ETH כיעד.
...
[MRC Global Pay کا فوری تبادلہ انٹرفیس](/#exchange) کھولیں۔
...
[رابط تبادل فوری MRC Global Pay](/#exchange) را باز کنید، BTC را مبدأ و ETH را مقصد تنظیم کنید.
...
Maak [MRC Global Pay se kitswisselkoppelvlak](/#exchange) oop.
...
[MRC Global Pay का इंस्टेंट स्वैप इंटरफेस](/#exchange) खोलें।
...
Mở [giao diện hoán đổi tức thì MRC Global Pay](/#exchange).
...
[MRC Global Pay'in anlık takas arayüzünü](/#exchange) açın.
...
Відкрийте [інтерфейс миттєвого обміну MRC Global Pay](/#exchange).
