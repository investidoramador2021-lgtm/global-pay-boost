...
`,
  ...
  ja: {
    ...
    metaDescription: "SEPA銀行振込でBitcoin、Ethereum、500以上のトークンを即座に購入。アカウント作成不要、60秒以内に決済完了。2026年最速のヨーロッパ向け暗号通貨オンランプ。手数料なし、ノンカストディアル。",
...
`,
  ...
  fa: {
    ...
    metaDescription: "خرید بیت‌کوین، اتریوم و بیش از 500 توکن با حواله بانکی SEPA. بدون ثبت‌نام، تسویه در کمتر از 60 ثانیه. سریع‌ترین آن-رمپ کریپتو اروپا در 2026. غیرامانی و بدون کارمزد پنهان.",
...
`,
  ...
  ur: {
    ...
    metaTitle: "SEPA Bank Transfer se Crypto Khareedein | MRC GlobalPay",
    metaDescription: "SEPA bank transfer se Bitcoin, Ethereum aur 500+ tokens khareedein. Registration nahi chahiye, 60 second mein settlement. Europe ka sabse tez crypto on-ramp 2026. Non-custodial.",
...
`,
  ...
  uk: {
    ...
    metaDescription: "Kupuite Bitcoin, Ethereum ta ponad 500 tokeniv cherez SEPA perekaz. Bez reiestratsii, rozrakhunok za 60 sekund. Naishvydshyi ievropeiskyi krypto on-remp 2026 roku. Nekastodialnyi.",
