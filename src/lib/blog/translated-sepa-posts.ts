...
`,
  ...
  ja: {
    ...
    metaDescription: "SEPA銀行振込でBitcoin、Ethereum、500以上のトークンを購入。登録不要、60秒以内に決済。2026年最速のヨーロッパ暗号通貨オンランプ。",
...
`,
  ...
  fa: {
    ...
    metaDescription: "خرید بیت‌کوین، اتریوم و بیش از 500 توکن با حواله بانکی SEPA. بدون ثبت‌نام، تسویه در کمتر از 60 ثانیه.",
...
`,
  ...
  he: {
    ...
    metaDescription: "קנו ביטקוין, אתריום ויותר מ-500 טוקנים בהעברת SEPA. ללא הרשמה, סליקה תוך 60 שניות.",
...
`,
  ...
  ur: {
    ...
    metaTitle: "SEPA Bank Transfer se Crypto Khareedein | MRC GlobalPay",
    metaDescription: "SEPA bank transfer se Bitcoin, Ethereum aur 500+ tokens khareedein. Registration nahi chahiye, 60 second mein settlement.",
...
`,
  ...
  uk: {
    ...
    metaDescription: "Kupuite Bitcoin, Ethereum ta ponad 500 tokenov cherez SEPA perekaz. Bez reiestratsii, rozrakhunok za 60 sekund.",
