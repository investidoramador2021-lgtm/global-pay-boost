...
`,
  ...
  fr: {
    ...
    metaDescription: "Achetez du Bitcoin, Ethereum et plus de 500 tokens avec votre Visa ou Mastercard. Sans compte, livraison en moins de 60 secondes.",
...
`,
  ...
  ja: {
    ...
    metaDescription: "VisaやMastercardでBitcoin、Ethereum、500以上のトークンを購入。アカウント不要、60秒以内にお届け。",
...
`,
  ...
  hi: {
    ...
    metaDescription: "अपने Visa या Mastercard से Bitcoin, Ethereum और 500+ टोकन खरीदें। कोई खाता नहीं, 60 सेकंड से कम में डिलीवरी।",
...
`,
  ...
  vi: {
    ...
    metaDescription: "Mua Bitcoin, Ethereum va hon 500 token bang Visa hoac Mastercard. Khong can tai khoan, giao hang trong vong 60 giay.",
...
`,
  ...
  fa: {
    ...
    metaDescription: "بیت‌کوین، اتریوم و بیش از 500 توکن را با ویزا یا مسترکارت بخرید. بدون حساب، تحویل در کمتر از 60 ثانیه.",
...
`,
  ...
  he: {
    ...
    metaDescription: "קנה ביטקוין, את'ריום ו-500+ טוקנים עם ויזה או מאסטרקארד. ללא חשבון, משלוח תוך פחות מ-60 שניות.",
...
`,
  ...
  ur: {
    ...
    metaDescription: "اپنے ویزا یا ماسٹرکارڈ سے بٹ کوائن، ایتھیریم اور 500+ ٹوکن خریدیں۔ کوئی اکاؤنٹ نہیں، 60 سیکنڈ سے کم میں ڈیلیوری۔",
