...
export const seoKeywords = [
  ...
  { keyword: "litecoin tracker", intentType: "Utility", targetUrl: "/tools/litecoin-tracker", primaryH1: "Litecoin Wallet & Transaction Tracker — Monitor LTC in Real Time", benefitHook: "Track any Litecoin wallet balance, transaction history, and confirmation status in real time. Swap LTC from $0.30 — no account required.",
    customTitle: "Litecoin Wallet Tracker — Monitor LTC Transactions & Balance | MRC GlobalPay",
    ...
    customSections: [
      ...
      { heading: "Why Use MRC GlobalPay for Litecoin Swaps?", body: "MRC GlobalPay supports Litecoin swaps starting at just $0.30 USD equivalent — the lowest minimum in the industry. Our non-custodial architecture means your LTC flows directly from your wallet to the destination without MRC ever holding your funds. As a FINTRAC-registered Canadian MSB (C100000015), we provide institutional-grade compliance with zero account requirements. Fixed-rate swaps lock your exchange rate for 60 seconds, and our aggregation engine sources liquidity from 700+ providers to guarantee the best available rate for every LTC pair." },
    ],
  },
  ...
  { keyword: "usdt erc20 meaning", intentType: "Informational", targetUrl: "/guides/usdt-erc20-meaning", primaryH1: "What Is USDT ERC20? — Complete Guide to Ethereum-Based Tether", benefitHook: "USDT ERC20 is Tether issued on the Ethereum blockchain as an ERC-20 token. Learn the difference between ERC20, TRC20, and other USDT variants — and swap between them instantly from $0.30.",
    customTitle: "What Is USDT ERC20? Meaning, Networks & How to Swap | MRC GlobalPay",
    ...
    customFaqs: [
      ...
      { q: "What is the difference between USDT ERC20 and TRC20?", a: "USDT ERC20 runs on Ethereum with higher gas fees ($1–$10+) and 12-second block times. USDT TRC20 runs on the TRON network with near-zero fees ($0.10–$0.50) and 3-second blocks. Both represent the same $1 USD value — the difference is the underlying blockchain. TRC20 is cheaper for transfers; ERC20 has deeper DeFi integration. MRC GlobalPay lets you swap between them instantly from $0.30." },
      { q: "Can I send USDT ERC20 to a TRC20 address?", a: "No. Sending USDT ERC20 to a TRC20 address (or vice versa) will result in permanent loss of funds. Ethereum addresses start with '0x' while TRON addresses start with 'T'. Always verify the network matches before sending. To convert between networks, use MRC GlobalPay's non-custodial swap — it handles the cross-chain conversion safely and instantly." },
      { q: "How much are USDT ERC20 gas fees?", a: "USDT ERC20 transfer gas fees depend on Ethereum network congestion. In 2026, typical fees range from $1–$10 for a simple transfer. During peak congestion, fees can exceed $20. For this reason, many users prefer USDT TRC20 (fees under $1) or USDT on Solana/BSC for smaller transfers. MRC GlobalPay includes all network fees in the displayed swap rate — no hidden costs." },
      { q: "Which USDT network is best?", a: "For DeFi and DEX trading: ERC20 (Ethereum) has the deepest liquidity. For low-cost transfers: TRC20 (TRON) offers fees under $0.50. For speed: Solana USDT settles in under 1 second. For BSC ecosystem: BEP20 is ideal. MRC GlobalPay supports all major USDT networks and lets you swap between them with no account, no KYC, and a $0.30 minimum." },
      { q: "Is USDT ERC20 the same as USDT?", a: "Yes and no. USDT is the stablecoin (1 USDT = $1 USD) issued by Tether. ERC20 specifies that this particular USDT exists on the Ethereum blockchain. USDT also exists on TRON (TRC20), Solana (SPL), BSC (BEP20), Avalanche, Polygon, and other chains. All variants are worth $1, but they are NOT interchangeable across networks without a bridge or swap service like MRC GlobalPay." },
    ],
    customSections: [
