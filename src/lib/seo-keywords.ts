...
export const seoKeywords = [
  ...
  { keyword: "ltc transaction tracker", intentType: "Utility", targetUrl: "/tools/ltc-tracker", primaryH1: "Litecoin (LTC) Transaction Tracker — Monitor & Swap LTC Instantly", benefitHook: "Track any Litecoin transaction in real time and swap LTC from $0.30 — no account, no KYC, non-custodial.",
    customTitle: "LTC Transaction Tracker — Track Litecoin Transactions in Real Time | MRC Global Pay",
  ...
  { keyword: "litecoin tracker", intentType: "Utility", targetUrl: "/tools/litecoin-tracker", primaryH1: "Litecoin Wallet & Transaction Tracker — Monitor LTC in Real Time", benefitHook: "Track any Litecoin wallet balance, transaction history, and confirmation status in real time. Swap LTC from $0.30 — no account required.",
    customTitle: "Litecoin Wallet Tracker — Monitor LTC Transactions & Balance | MRC Global Pay",
    customDescription: "Free Litecoin wallet and transaction tracker. Monitor LTC balances, track confirmations, view transaction history. Swap Litecoin instantly from $0.30 with no registration. FINTRAC-registered MSB.",
    customFaqs: [
  ...
  { keyword: "dusd portal", intentType: "Commercial", targetUrl: "/ecosystem/dusd", primaryH1: "DUSD Stablecoin Portal", benefitHook: "Gateway for Decentralized USD swaps.",
    customTitle: "DUSD Portal — Swap Decentralized USD Stablecoin Instantly | MRC Global Pay",
    customDescription: "DUSD (Decentralized USD) portal: swap DUSD against BTC, ETH, USDT and 6,000+ assets from $0.30. No account, no KYC, non-custodial settlement — Canadian MSB-registered." },
  ...
  { keyword: "tether pro", intentType: "Commercial", targetUrl: "/ecosystem/tether-pro", primaryH1: "Tether Pro Advanced Swaps", benefitHook: "High-volume USDT liquidity for pros.",
    customTitle: "Tether Pro — High-Volume USDT Swaps & Pro Liquidity | MRC Global Pay",
    customDescription: "Tether Pro: high-volume USDT swaps across ERC20, TRC20, BEP20 and Solana. Aggregated liquidity from 700+ sources, $0.30 minimum, no account required. Canadian MSB-registered." },
  ...
  { keyword: "usdt erc20 meaning", intentType: "Informational", targetUrl: "/guides/usdt-erc20-meaning", primaryH1: "What Is USDT ERC20? — Complete Guide to Ethereum-Based Tether", benefitHook: "USDT ERC20 is Tether issued on the Ethereum blockchain as an ERC-20 token. Learn the difference between ERC20, TRC20, and other USDT variants — and swap between them instantly from $0.30.",
    customTitle: "What Is USDT ERC20? Meaning, Networks & How to Swap | MRC Global Pay",
    customDescription: "USDT ERC20 explained: Tether on Ethereum vs TRC20 vs BEP20. Learn contract addresses, gas fees, and how to swap USDT between networks instantly from $0.30 with no account.",
    customFaqs: [
  ...
  { keyword: "dgb wallet", intentType: "Informational", targetUrl: "/reviews/dgb-wallet", primaryH1: "Best DigiByte (DGB) Wallets", benefitHook: "Store and trade DGB assets securely.",
    customTitle: "Best DGB Wallet 2026 — Top DigiByte Wallets Reviewed | MRC Global Pay",
    customDescription: "Best DigiByte (DGB) wallets reviewed for 2026: hardware, mobile and desktop options compared. Plus instant DGB swaps from $0.30 — no account, non-custodial, Canadian MSB." },
  ...
  { keyword: "swap aggregator", intentType: "Informational", targetUrl: "/guides/swap-aggregator", primaryH1: "What Is a Swap Aggregator? — Best Crypto Swap Aggregators in 2026", benefitHook: "A swap aggregator routes your trade across multiple liquidity sources to find the best rate. MRC Global Pay aggregates 700+ providers for instant, non-custodial swaps from $0.30.",
    customTitle: "Best Crypto Swap Aggregator 2026 — 700+ Liquidity Sources | MRC Global Pay",
    customDescription: "What is a swap aggregator? Compare the best crypto swap aggregators in 2026. MRC Global Pay aggregates 700+ liquidity sources for the best rates — no account, no KYC, from $0.30.",
    customFaqs: [
