...
export const PRIORITY_TOKEN_ASSETS: Record<string, PriorityTokenAsset> = {
  PEPE: {
    ...
    name: "Pepe",
    heroImage: heroPepe,
    heroAlt: "PEPE memecoin token coin emblem with green liquidity flow over candlestick chart — MRC GlobalPay 2026 swap guide",
  ...
  DOGE: {
    ...
    name: "Dogecoin",
    heroImage: heroDoge,
    heroAlt: "Dogecoin (DOGE) gold coin emblem with green chart wave — MRC GlobalPay 2026 buying guide",
  ...
  XRP: {
    ...
    name: "XRP",
    heroImage: heroXrp,
    heroAlt: "XRP Ripple silver coin emblem with green cross-border payment arcs — MRC GlobalPay 2026 XRP buying guide",
  ...
  HYPE: {
    ...
    name: "Hyperliquid",
    heroImage: heroHype,
    heroAlt: "Hyperliquid HYPE token coin with motion-blur racing lines and green order-book depth — MRC GlobalPay 2026 perp DEX guide",
  ...
  TAO: {
    ...
    name: "Bittensor",
    heroImage: heroTao,
    heroAlt: "Bittensor TAO neural-mesh coin emblem with orbiting AI subnets and green data filaments — MRC GlobalPay 2026 decentralized AI guide",
  ...
  SIREN: {
    ...
    name: "SIREN",
    heroImage: heroSiren,
    heroAlt: "SIREN BEP-20 token coin emblem with green sonar pulse and contract-verification glyphs — MRC GlobalPay 2026 SIREN guide",
  ...
  BDAG: {
    ...
    name: "BlockDAG",
    heroImage: heroBdag,
    heroAlt: "BlockDAG BDAG coin emblem connected to a green DAG block-network mesh — MRC GlobalPay 2026 BDAG buying guide",
