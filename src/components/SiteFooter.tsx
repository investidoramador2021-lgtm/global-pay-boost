const stablecoinBridges = [
  { label: "USDT to TRX", href: "/exchange/usdt-to-trx", title: "Swap USDT to TRX instantly" },
  { label: "USDT to SOL", href: "/exchange/usdt-to-sol", title: "Swap USDT to SOL instantly" },
  { label: "USDT to LTC", href: "/exchange/usdt-to-ltc", title: "Swap USDT to Litecoin instantly" },
  { label: "USDC to SOL", href: "/exchange/usdc-to-sol", title: "Swap USDC to SOL instantly" },
  { label: "USDT to BTC", href: "/exchange/usdt-to-btc", title: "Swap USDT to Bitcoin instantly" },
  { label: "USDC to ETH", href: "/exchange/usdc-to-eth", title: "Swap USDC to Ethereum instantly" },
  { label: "DAI to USDT", href: "/exchange/dai-to-usdt", title: "Swap DAI to USDT instantly" },
  { label: "USDT to XRP", href: "/exchange/usdt-to-xrp", title: "Swap USDT to XRP instantly" },
  { label: "USDT to DOGE", href: "/exchange/usdt-to-doge", title: "Swap USDT to Dogecoin instantly" },
  { label: "USDC to BTC", href: "/exchange/usdc-to-btc", title: "Swap USDC to Bitcoin instantly" },
  { label: "ETH to SOL Bridge", href: "/exchange/eth-to-sol", title: "Bridge Ethereum to Solana instantly" },
  { label: "SOL to BNB Bridge", href: "/exchange/sol-to-bnb", title: "Bridge Solana to BNB Chain instantly" },
  { label: "PYUSD to USDT", href: "/exchange/pyusd-to-usdt", title: "Swap PayPal USD to USDT instantly" },
];

const popularCryptoSwaps = [
  { label: "ETH to SOL", href: "/exchange/eth-to-sol", title: "Swap Ethereum to Solana instantly" },
  { label: "BTC to SOL", href: "/exchange/btc-to-sol", title: "Swap Bitcoin to Solana instantly" },
  { label: "XMR to ETH", href: "/exchange/xmr-to-eth", title: "Swap Monero to Ethereum instantly" },
  { label: "BNB to BTC", href: "/exchange/bnb-to-btc", title: "Swap BNB to Bitcoin instantly" },
  { label: "BTC to USDC", href: "/exchange/btc-to-usdc", title: "Swap Bitcoin to USDC instantly" },
  { label: "SHIB to USDT", href: "/exchange/shib-to-usdt", title: "Swap Shiba Inu to USDT instantly" },
  { label: "HYPE to USDT", href: "/exchange/hype-to-usdt", title: "Swap HYPE to USDT instantly" },
  { label: "BERA to USDT", href: "/exchange/bera-to-usdt", title: "Swap Berachain to USDT instantly" },
  { label: "DOGE to BTC", href: "/exchange/doge-to-btc", title: "Swap Dogecoin to Bitcoin instantly" },
  { label: "SOL to USDT", href: "/exchange/sol-to-usdt", title: "Swap Solana to USDT instantly" },
  { label: "XRP to USDT", href: "/exchange/xrp-to-usdt", title: "Swap XRP to USDT instantly" },
  { label: "ADA to BTC", href: "/exchange/ada-to-btc", title: "Swap Cardano to Bitcoin instantly" },
  { label: "LTC to ETH", href: "/exchange/ltc-to-eth", title: "Swap Litecoin to Ethereum instantly" },
];
  ...
  return (
    <footer className="border-t border-border bg-muted py-10 sm:py-16">
      <div className="container mx-auto px-4">
        ...
        {/* Regional Hubs — deep localized landing pages */}
        <nav aria-label="Regional Hubs" className="mt-10 border-t border-border pt-8">
          ...
          <ul className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <li>
              <a
                href="/vi/vietnam"
                title="MRC Việt Nam — Giao dịch SOL & HYPE phi lưu ký"
              ...
              >
                <span className="font-display text-sm font-semibold text-foreground">🇻🇳 Việt Nam Hub</span>
                <span className="mt-0.5 block text-xs text-muted-foreground">SOL · HYPE · Phi lưu ký</span>
              </a>
            </li>
            <li>
              <a
                href="/tr"
                title="MRC Türkiye — HYPE & XAUt için hızlı kripto takas"
                className="block rounded-lg border border-border bg-card/40 px-3 py-2.5 transition-colors hover:border-primary/40 hover:bg-card/80"
              >
                <span className="font-display text-sm font-semibold text-foreground">🇹🇷 Türkiye Hub</span>
                <span className="mt-0.5 block text-xs text-muted-foreground">HYPE · XAUt · Lira</span>
              </a>
            </li>
            <li>
              <a
                ...
                className="block rounded-lg border border-border bg-card/40 px-3 py-2.5 transition-colors hover:border-primary/40 hover:bg-card/80"
              >
                <span className="font-display text-sm font-semibold text-foreground">🇧🇷 Brasil Hub</span>
            ...
            <li>
              <a
                href="/es"
                title="MRC Español — Intercambio de cripto sin registro"
                className="block rounded-lg border border-border bg-card/40 px-3 py-2.5 transition-colors hover:border-primary/40 hover:bg-card/80"
              >
                <span className="font-display text-sm font-semibold text-foreground">🇪🇸 Español Hub</span>
                <span className="mt-0.5 block text-xs text-muted-foreground">EUR · MXN · Sin KYC</span>
              </a>
            </li>
          </ul>
        </nav>
