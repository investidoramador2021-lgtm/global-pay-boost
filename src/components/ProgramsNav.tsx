...
export const ProgramsFooterLinks = ({ active }: { active: Active }) => {
  ...
  const lang = i18n.resolvedLanguage ?? i18n.language ?? "en";
  const copy = {
    en: { affiliates: "Affiliates", partners: "Partners", referral: "Referral", explore: "Explore our programs", title: "Three ways to earn lifetime BTC with MRC Global Pay", affiliatesDesc: "Embed our swap widget. Marketing assets + dashboard.", partnersDesc: "Private dashboard, settlement reporting, negotiated rates.", referralDesc: "One simple link. No setup. Best for casual sharers.", program: "Program", current: "You are here", note: "All programs pay in BTC and operate under FINTRAC MSB #C100000015 and Bank of Canada PSP registration." },
    es: { affiliates: "Afiliados", partners: "Socios", referral: "Referidos", explore: "Explora nuestros programas", title: "Tres formas de ganar BTC de por vida con MRC Global Pay", affiliatesDesc: "Incrusta nuestro widget de swap. Materiales de marketing + panel.", partnersDesc: "Panel privado, reportes de liquidación y tarifas negociadas.", referralDesc: "Un enlace simple. Sin configuración. Ideal para compartir casualmente.", program: "Programa", current: "Estás aquí", note: "Todos los programas pagan en BTC y operan bajo el registro FINTRAC MSB #C100000015 y el registro PSP del Banco de Canadá." },
    fr: { affiliates: "Affiliation", partners: "Partenaires", referral: "Parrainage", explore: "Découvrez nos programmes", title: "Trois façons de gagner du BTC à vie avec MRC Global Pay", affiliatesDesc: "Intégrez notre widget de swap. Ressources marketing + tableau de bord.", partnersDesc: "Tableau de bord privé, rapports de règlement, tarifs négociés.", referralDesc: "Un lien simple. Aucun paramétrage. Idéal pour un partage occasionnel.", program: "Programme", current: "Vous êtes ici", note: "Tous les programmes paient en BTC et fonctionnent sous l'enregistrement FINTRAC MSB #C100000015 et l'enregistrement PSP de la Banque du Canada." },
  } as const;
